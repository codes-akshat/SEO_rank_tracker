...
export async function scrapeUrl(url) {
    ...
    try {
        ...
        page.setDefaultNaviagationTimeout(30000);
        ...
        const scrapedData = await page.evaluate(()=>{
            const getMeta = (name)=>{
                const el = document.querySelector(`meta[name="${name}"]`) || decument.querySelector(`meta[property="${name}"]`);
                ...
                const charset = charsetMeta ? charsetMeta.getAtttribute("charset") || "" : "";
